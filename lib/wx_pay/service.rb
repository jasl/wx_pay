...
module WxPay
  module Service
    ...
    def self.invoke_unifiedorder(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/pay/unifiedorder", make_payload(params), options).body)
    ...
    def self.invoke_closeorder(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/pay/closeorder", make_payload(params), options).body)
    ...
    def self.invoke_refund(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/secapi/pay/refund", make_payload(params), options).body)
    ...
    def self.refund_query(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/pay/refundquery", make_payload(params), options).body)
    ...
    def self.invoke_transfer(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/mmpaymkttransfers/promotion/transfers", make_payload(params), options).body)
    ...
    def self.gettransferinfo(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/mmpaymkttransfers/gettransferinfo", make_payload(params), options).body)
    ...
    def self.invoke_reverse(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/secapi/pay/reverse", make_payload(params), options).body)
    ...
    def self.invoke_micropay(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/pay/micropay", make_payload(params), options).body)
    ...
    def self.order_query(params, options = {})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/pay/orderquery", make_payload(params), options).body)
      check_required_options(params, ORDER_QUERY_REQUIRED_FIELDS)
    ...
    def self.sendgroupredpack(params, options={})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/mmpaymkttransfers/sendgroupredpack", make_payload(params), options).body)
    ...
    def self.sendredpack(params, options={})
      ...
      r = WxPay::Result.new(invoke_remote("#{GATEWAY_URL}/mmpaymkttransfers/sendredpack", make_payload(params), options).body)
